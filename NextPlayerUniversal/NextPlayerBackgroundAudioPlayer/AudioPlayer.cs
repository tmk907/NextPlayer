...
namespace NextPlayerBackgroundAudioPlayer
{
    ...
    public sealed class AudioPlayer : IBackgroundTask
    {
        ...
        {
            NextPlayerUniversal.Diagnostics.Logger.SaveBG("BG Task Started");
            NextPlayerUniversal.Diagnostics.Logger.SaveToFileBG();
        ...
        private void OnCanceled(IBackgroundTaskInstance sender, BackgroundTaskCancellationReason reason)
        {
            try
            {
                ...
                NextPlayerUniversal.Diagnostics.Logger.SaveBG("BG Before Cancel");
                NextPlayerUniversal.Diagnostics.Logger.SaveToFileBG();
                BackgroundMediaPlayer.MessageReceivedFromForeground -= MessageReceivedFromForeground;
                //ValueSet message = new ValueSet();
            ...
            NextPlayerUniversal.Diagnostics.Logger.SaveBG("BG After Cancel");
            NextPlayerUniversal.Diagnostics.Logger.SaveToFileBG();
            ...
            switch (args.Button)
            {
                case SystemMediaTransportControlsButton.Play:
                    if (!backgroundTaskStatus)
                    {
                        ...
                        if (!result)
                        {
                            NextPlayerUniversal.Diagnostics.Logger.SaveBG("BG not initialized, UVCO play button");
                            NextPlayerUniversal.Diagnostics.Logger.SaveToFileBG();
        ...
        {
            //Pause();
            //NextPlayerUniversal.Diagnostics.Logger.SaveBG("BG Shutdown");
            //NextPlayerUniversal.Diagnostics.Logger.SaveToFileBG();
            shutdown = true;
            BackgroundMediaPlayer.Shutdown();
        }
        ...
        {
            //NextPlayerUniversal.Diagnostics.Logger.SaveBG("BG Timer Cancel");
            ShutdownPlayer();
            //ClearPlayer();
