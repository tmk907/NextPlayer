...
namespace NextPlayerUniversal.ViewModel
{
    public class MainPageViewModel : ViewModelBase, INavigable
    {
                ...
                return goToNowPlaying
                    ...
                    () =>
                    {
                        if (CurrentSongIndex > -1)
                        {
                            ...
                            {
                                //NextPlayerUniversal.Diagnostics.Logger.Save("FG Main closed");
                            ...
                            else
                            {
                                ...
                                {
                                    NextPlayerUniversal.Common.SuspensionManager.SessionState.Add("mainpage", true);
                                }
                                //NextPlayerUniversal.Diagnostics.Logger.Save("FG Main not closed");
                                //NextPlayerUniversal.Diagnostics.Logger.SaveToFile();
        ...
        {
            //NextPlayerUniversal.Diagnostics.Logger.Save("FG Main activate");
            //NextPlayerUniversal.Diagnostics.Logger.SaveToFile();
