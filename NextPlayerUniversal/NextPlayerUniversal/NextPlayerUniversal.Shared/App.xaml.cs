...
namespace NextPlayerUniversal
{
    ...
    public sealed partial class App : Application
    {
        ...
        {
            string s = await NextPlayerUniversal.Diagnostics.Logger.ReadAll();
            //NextPlayerDataLayer.Diagnostics.Logger.Clear();
        }
        ...
        void App_UnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            ...
            NextPlayerUniversal.Diagnostics.Logger.Save(e.Exception.ToString() + "\nMessage:\n" + e.Message);
