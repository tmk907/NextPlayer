...
namespace NextPlayerUniversal.Common
{
    /// <summary>
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        RelayCommandWin _goBackCommand;
        RelayCommandWin _goForwardCommand;

        /// <summary>
        /// <see cref="RelayCommandWin"/> used to bind to the back Button's Command property
        /// for navigating to the most recent item in back navigation history, if a Frame
        /// manages its own navigation history.
        /// 
        /// The <see cref="RelayCommandWin"/> is set up to use the virtual method <see cref="GoBack"/>
        /// as the Execute Action and <see cref="CanGoBack"/> for CanExecute.
        /// </summary>
        public RelayCommandWin GoBackCommand
        {
            get
            {
                if (_goBackCommand == null)
                {
                    _goBackCommand = new RelayCommandWin(
                        () => this.GoBack(),
                        () => this.CanGoBack());
                }
        ...
        /// <summary>
        /// <see cref="RelayCommandWin"/> used for navigating to the most recent item in 
        /// the forward navigation history, if a Frame manages its own navigation history.
        /// 
        /// The <see cref="RelayCommandWin"/> is set up to use the virtual method <see cref="GoForward"/>
        /// as the Execute Action and <see cref="CanGoForward"/> for CanExecute.
        /// </summary>
        public RelayCommandWin GoForwardCommand
        {
            get
            {
                if (_goForwardCommand == null)
                {
                    _goForwardCommand = new RelayCommandWin(
                        () => this.GoForward(),
                        () => this.CanGoForward());
                }
