...
namespace NextPlayer.View
{
    ...
    public sealed partial class PlaylistView : Page
    {
        ...
        {
            string log = String.Format("Playlist AdMediatorError {0} {1}", e.ErrorCode, e.Error);
        ...
        {
            string log = String.Format("Playlist AdSdkError {0} {1} {2} {3} {4} {5}", e.ErrorCode, e.ErrorDescription, e.Error, e.EventName, e.Name, e.SdkEventArgs);
            System.Diagnostics.Debug.WriteLine(log);
        ...
        {
            System.Diagnostics.Debug.WriteLine("Playlist AdMediatorFilled {0} {1} {2}", e.EventName, e.Name, e.SdkEventArgs);
        }

        private void AdMediator_Playlists_AdSdkEvent(object sender, Microsoft.AdMediator.Core.Events.AdSdkEventArgs e)
        {
            System.Diagnostics.Debug.WriteLine("Playlist AdSdkEvent {0} {1} {2}", e.EventName, e.Name, e.SdkEventArgs);
        }
    }
}
